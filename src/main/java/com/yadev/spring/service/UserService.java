...
import com.yadev.spring.mapper.UserReadMapper;
import com.yadev.spring.mapper.UserCreateEditMapper;
...
public class UserService implements UserDetailsService {
    ...
    public Optional<UserReadDto> update(Long id, UserCreateEditDto userDto) {
        return userRepository.findById(id)
                ...
                .map(userRepository::saveAndFlush) //no request to the db without 'flush', thus we can get exception on dif.level
                .map(userReadMapper::map);
    }
